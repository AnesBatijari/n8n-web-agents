                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <li class="border-t border-white-light dark:border-white-light/10">
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit"
                                    class="flex items-center w-full px-4 py-3 text-danger hover:bg-gray-100 dark:hover:bg-white-light/10">

                                    <svg class="w-4.5 h-4.5 ltr:mr-3 rtl:ml-3 shrink-0 rotate-90"
