        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="/assets/images/komit-tech.png" alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">KOMIT TECH</span>
                </a>
                <a href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <a type="button" href="/" class="nav-link group">
                    ...
                    <ul>
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                :class="{ 'active': activeDropdown === 'seo-audits' }"
                                @click="activeDropdown === 'seo-audits' ? activeDropdown = null : activeDropdown = 'seo-audits'">
                                <div class="flex items-center">
                                    <svg class="group-hover:!text-primary shrink-0" width="20" height="20"
                                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.5"
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">SEO
                                        Audits</span>
                                </div>
                                <div class="rtl:rotate-180"
                                    :class="{ '!rotate-90': activeDropdown === 'seo-audits' }">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'seo-audits'" x-collapse
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                :class="{ 'active': activeDropdown === 'potenzial' }"
                                @click="activeDropdown === 'potenzial' ? activeDropdown = null : activeDropdown = 'potenzial'">
                                <div class="flex items-center">
                                     <svg class="group-hover:!text-primary shrink-0" width="20" height="20"
                                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.5"
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Potenzial
                                        Analyses</span>
                                </div>
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'potenzial' }">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'potenzial'" x-collapse
                                class="sub-menu text-gray-500">
                                <li>
                                    <a href="{{ route('potenzial.create') }}"
                                        class="block px-2 py-1.5 rounded-md text-sm font-normal text-gray-700 hover:bg-gray-50
                                ...
                                <li>
                                    <a href="{{ route('potenzial.settings.edit') }}"
                                        class="block px-2 py-1.5 rounded-md text-sm font-normal text-gray-700 hover:bg-gray-50
                                        {{ request()->routeIs('potenzial.settings.edit') ? 'text-[var(--brand)]' : '' }}">
                                        Settings
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                :class="{ 'active': activeDropdown === 'kw-research' }"
                                @click="activeDropdown === 'kw-research' ? activeDropdown = null : activeDropdown = 'kw-research'">
                                <div class="flex items-center">
                                     <svg class="group-hover:!text-primary shrink-0" width="20" height="20"
                                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Keyword
                                        Research</span>
                                </div>
                                <div class="rtl:rotate-180"
                                    :class="{ '!rotate-90': activeDropdown === 'kw-research' }">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'kw-research'" x-collapse
                                class="sub-menu text-gray-500">
                                <li>
                                    <a href="{{ route('/') }}"
                                        class="block px-2 py-1.5 rounded-md text-sm font-normal text-gray-700 hover:bg-gray-50
                                        {{ request()->routeIs('/') ? 'text-[var(--brand)]' : '' }}">
                                        Create
                                    </a>
                                </li>
                                <li>
