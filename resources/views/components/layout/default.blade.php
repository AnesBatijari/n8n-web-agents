...
<head>
    ...
    <title>{{ $title ?? 'n8n Web Agents' }}</title>

    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <link rel="icon" type="image/svg" href="/assets/images/komit-tech.jpg" />
...
>
    ...
    {{-- Keep ONLY custom theme JS here if it depends on Alpine being available globally --}}
