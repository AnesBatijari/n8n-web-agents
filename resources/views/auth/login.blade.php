    ...
    <div x-data="auth">
        ...
        <div class="relative flex min-h-screen items-center justify-center bg-[url(/assets/images/auth/map.png)] bg-cover bg-center bg-no-repeat px-4 py-6 dark:bg-[#060818] sm:px-6 lg:px-16 lg:py-10">
            ...
            <div class="relative w-full max-w-7xl rounded-md">
                <div class="relative flex flex-col overflow-hidden rounded-md bg-white/40 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row">

                    <!-- Left column -->
                    <div class="flex w-full items-center justify-center lg:w-1/2">
                        <div class="flex w-full items-center justify-center overflow-hidden rounded-t-md lg:h-full lg:rounded-l-md lg:rounded-tr-none">
                            <img
                        ...
                        <div class="mx-auto w-full max-w-[440px]">
                            <div class="mb-8 lg:mb-10">
                                ...
                                <p class="text-sm font-bold leading-normal text-white-dark sm:text-base">
                                    {{ __('app.Enter your email and password to login') }}
                                </p>
                            </div>
                            ...
                            <div class="text-center dark:text-white">
                                ...
                                <a href="{{ route('register') }}" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">
                                    {{ __('app.Sign up') }}
                                </a>
                            </div>
                        </div>
